        ...
        <div className="glass-card-deep p-8" style={{ borderColor: 'rgba(124,58,237,0.15)' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <>
                <div className="relative">
                  ...
                  <input type="text" placeholder="Full Name" value={form.name}
                    ...
                    className="w-full bg-[#F0F4FF] border border-[#DBEAFE] rounded-xl px-11 py-3 text-sm text-slate-900 placeholder-dark-400 outline-none focus:border-brand-500/50 focus:bg-[#F0F4FF] transition-all" required />
                </div>
                <div className="relative">
                  ...
                  <input type="text" placeholder="Business Name (optional)" value={form.business_name}
                    ...
                    className="w-full bg-[#F0F4FF] border border-[#DBEAFE] rounded-xl px-11 py-3 text-sm text-slate-900 placeholder-dark-400 outline-none focus:border-brand-500/50 focus:bg-[#F0F4FF] transition-all" />
                </div>
              </>
            )}
            ...
            <button type="submit" disabled={loading}
              className="w-full py-3 rounded-xl text-slate-900 font-semibold text-sm btn-premium disabled:opacity-50"
              style={{ background: 'linear-gradient(135deg, #7c3aed, #6366f1, #14b8a6)' }}>
