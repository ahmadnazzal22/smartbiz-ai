      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-6 mt-8">
            <button onClick={prev} className="w-12 h-12 rounded-full glass-card flex items-center justify-center text-dark-300 hover:text-slate-900 hover:border-brand-500/30 transition-all">
              ...
              {testimonials.map((_, i) => (
                <button key={i} onClick={() => setActive(i)}
                  className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${
                    i === active ? 'bg-brand-400 w-8' : 'bg-dark-600 hover:bg-dark-400'
                  }`} />
              ))}
            </div>
            <button onClick={next} className="w-12 h-12 rounded-full glass-card flex items-center justify-center text-dark-300 hover:text-slate-900 hover:border-brand-500/30 transition-all">
