...
const features = [
  ...
  { icon: MessageCircle, title: 'WhatsApp Integration', desc: 'Connect your number in one click. Every conversation gets an instant AI reply. No more missed calls or slow responses.', gradient: 'from-primary-500 to-cyan-500', stats: '3,200+ conversations/mo' },
  { icon: Calendar, title: 'Smart Booking Engine', desc: 'Customers book directly from WhatsApp. AI checks availability, confirms instantly, and sends automatic reminders. No double bookings.', gradient: 'from-accent-500 to-emerald-500', stats: '98% booking accuracy' },
...
export default function Features() {
  ...
  return (
    <section id="features" className="relative py-32 overflow-hidden">
      ...
      <div className="hero-glow" style={{ background: '#14b8a6', bottom: '30%', right: '-5%' }} />
