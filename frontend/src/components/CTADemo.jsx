        ...
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <div className="relative px-8 py-20 sm:px-20 sm:py-28 text-center space-y-8">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
              ...
              <Link to="/pricing"
                className="px-10 py-5 glass-card rounded-full text-dark-200 font-semibold text-lg flex items-center gap-2 hover:text-white hover:border-accent-500/30 transition-all duration-300">
                View Plans
              </Link>
              <Link to="/login"
